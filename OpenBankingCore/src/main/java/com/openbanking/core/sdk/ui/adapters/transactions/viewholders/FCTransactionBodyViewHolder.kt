...
import com.openbanking.core.sdk.databinding.ItemTransactionsBinding
import com.openbanking.core.sdk.extensions.*
...
import com.openbanking.core.sdk.ui.adapters.transactions.models.FCTransactionCategory
import com.openbanking.core.sdk.utils.ImageViewUtils
import com.openbanking.core.sdk.utils.Utils
...
class FCTransactionBodyViewHolder<T>(
    ...
    private fun configAmount(amount: Double, configAmountColor: Boolean) = with(mBinding.tvAmount) {
        ...
        if(configAmountColor){
            if (amount > 0) {
                setTextColor(ContextCompat.getColor(context, com.openbanking.core.sdk.R.color.colorBudgetGreen))
            } else {
                setTextColor(ContextCompat.getColor(context, com.openbanking.core.sdk.R.color.colorBudgetRed))
            }
        } else {
            setTextColor(ContextCompat.getColor(context, com.openbanking.core.sdk.R.color.colorDarkGray))
        }
    }
